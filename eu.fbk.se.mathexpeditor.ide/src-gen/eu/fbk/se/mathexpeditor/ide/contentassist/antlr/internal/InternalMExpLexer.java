...
public class InternalMExpLexer extends Lexer {
    ...
    public final void mRULE_OPERATOR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1158:15: ( ( '+' | '-' | 'x' ) )
            // InternalMExp.g:1158:17: ( '+' | '-' | 'x' )
            {
            if ( input.LA(1)=='+'||input.LA(1)=='-'||input.LA(1)=='x' ) {
                input.consume();
    ...
    public final void mRULE_EQUAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1160:12: ( '=' )
            // InternalMExp.g:1160:14: '='
            {
            match('='); 
    ...
    public final void mRULE_ASSIGN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1162:13: ( ':=' )
            // InternalMExp.g:1162:15: ':='
            {
            match(":="); 
    ...
    public final void mRULE_SEMICOLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1164:16: ( ';' )
            // InternalMExp.g:1164:18: ';'
            {
            match(';'); 
    ...
    public final void mRULE_COLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1166:12: ( ':' )
            // InternalMExp.g:1166:14: ':'
            {
            match(':'); 
    ...
    public final void mRULE_L_BRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1168:16: ( '(' )
            // InternalMExp.g:1168:18: '('
            {
            match('('); 
    ...
    public final void mRULE_R_BRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1170:16: ( ')' )
            // InternalMExp.g:1170:18: ')'
            {
            match(')'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1172:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMExp.g:1172:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMExp.g:1172:11: ( '^' )?
            int alt1=2;
            ...
            // InternalMExp.g:1172:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1174:10: ( ( '0' .. '9' )+ )
            // InternalMExp.g:1174:12: ( '0' .. '9' )+
            {
            // InternalMExp.g:1174:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1176:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMExp.g:1176:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMExp.g:1176:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalMExp.g:1176:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMExp.g:1176:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalMExp.g:1176:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMExp.g:1176:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1178:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMExp.g:1178:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMExp.g:1178:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1180:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMExp.g:1180:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMExp.g:1180:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1182:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMExp.g:1182:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMExp.g:1182:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMExp.g:1184:16: ( . )
            // InternalMExp.g:1184:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\1\uffff\3\24\1\27\1\uffff\1\32\3\uffff\1\22\3\uffff\3\22\2\uffff\1\24\1\uffff\2\24\14\uffff\1\24\1\47\1\50\1\24\2\uffff\1\52\1\uffff";
    static final String DFA12_eofS =
        "\53\uffff";
    static final String DFA12_minS =
        "\1\0\1\157\1\141\1\170\1\60\1\uffff\1\75\3\uffff\1\101\3\uffff\2\0\1\52\2\uffff\1\156\1\uffff\1\162\1\160\14\uffff\1\163\2\60\1\164\2\uffff\1\60\1\uffff";
    static final String DFA12_maxS =
        "\1\uffff\1\157\1\141\1\170\1\172\1\uffff\1\75\3\uffff\1\172\3\uffff\2\uffff\1\57\2\uffff\1\156\1\uffff\1\162\1\160\14\uffff\1\163\2\172\1\164\2\uffff\1\172\1\uffff";
    static final String DFA12_acceptS =
        "\5\uffff\1\5\1\uffff\1\7\1\11\1\12\1\uffff\1\4\1\13\1\14\3\uffff\1\20\1\21\1\uffff\1\13\2\uffff\1\4\1\5\1\6\1\10\1\7\1\11\1\12\1\14\1\15\1\16\1\17\1\20\4\uffff\1\2\1\3\1\uffff\1\1";
    static final String DFA12_specialS =
        "\1\0\15\uffff\1\2\1\1\33\uffff}>";
    static final String[] DFA12_transitionS = {
            "\11\22\2\21\2\22\1\21\22\22\1\21\1\22\1\16\4\22\1\17\1\10\1\11\1\22\1\13\1\22\1\13\1\22\1\20\12\15\1\6\1\7\1\22\1\5\3\22\2\14\1\1\1\14\1\3\20\14\1\2\4\14\3\22\1\12\1\14\1\22\27\14\1\4\2\14\uff85\22",
            "\1\23",
            "\1\25",
            "\1\26",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( (LA12_0=='+'||LA12_0=='-') ) {s = 11;}

                        else if ( ((LA12_0>='A' && LA12_0<='B')||LA12_0=='D'||(LA12_0>='F' && LA12_0<='U')||(LA12_0>='W' && LA12_0<='Z')||LA12_0=='_'||(LA12_0>='a' && LA12_0<='w')||(LA12_0>='y' && LA12_0<='z')) ) {s = 12;}
